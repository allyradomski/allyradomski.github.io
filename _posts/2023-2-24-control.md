...
![Creating a garden with Jardim]({{ site.baseurl }}/images/journal/year2/control/jardim.png)
...
![Sketch 1]({{ site.baseurl }}/images/journal/year2/control/idea-1.png)
...
![Attempting to connect points using a voronoi diagram]({{ site.baseurl }}/images/journal/year2/control/voronoi-attempt.jpg)
...
![Using quickhull3d]({{ site.baseurl }}/images/journal/year2/control/quickhull3d.jpg)
...
![Conversation between ChatGPT]({{ site.baseurl }}/images/journal/year2/control/chatgpt.mp4)
...
![Video of height map and color map working]({{ site.baseurl }}/images/journal/year2/control/heightmap.mp4)

![One of the height maps created]({{ site.baseurl }}/images/journal/year2/control/waa.png)
![One of the pairing color maps created]({{ site.baseurl }}/images/journal/year2/control/woo.png)
...
![Demo of a planet]({{ site.baseurl }}/images/journal/year2/control/planetdemo.mp4)
...
![Demo of a planet with scrolling stars background]({{ site.baseurl }}/images/journal/year2/control/starsdemo.mp4)
...
![Demo of a planet with scrolling stars background]({{ site.baseurl }}/images/journal/year2/control/outlinedemo.mp4)
